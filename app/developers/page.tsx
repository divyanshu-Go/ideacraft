...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Case studies from IdeaCraft — real problems solved with custom software for businesses across Delhi NCR and beyond.",
};
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="mt-20 p-10 rounded-xl border border-border bg-surface text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-xs font-mono text-cyan/70 tracking-widest uppercase mb-3">// Your project next?</p>
            ...
            <p className="text-muted mb-6 max-w-md mx-auto text-sm leading-relaxed">
              Tell us what you&apos;re working on. We&apos;ll get back within 24 hours with a clear proposal.
            </p>
